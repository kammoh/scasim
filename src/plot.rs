...
pub fn plot_max_t_values(
    ...
    let html_output_path = output_dir.join(max_t_plot_file_stem.with_extension("html"));
    ...
    //     1.0,
    // );
    let max_t_plot_json_path = output_dir.join(max_t_plot_file_stem.with_extension("json"));
